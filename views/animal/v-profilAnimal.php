<main class="flex-grow-1">
    <div class="container my-5">
                ...
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <span class="badge bg-info"><?= htmlspecialchars($animal['ID_ANIMAL'] ?? 'N/A') ?></span>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <span><?= htmlspecialchars($animal['ID_ESPECE'] ?? 'Non spécifiée') ?></span>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info d-flex align-items-center" role="alert">
                            <div>
                                ...
                                Animal en bonne santé et bien suivi.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-3 mt-4">
            <div class="col-auto">
                <a href="index.php?action=home" class="btn btn-outline-primary">
